# MiniGit (mgit)
Reimplementation of Git, written in Python

## Overview
MiniGit is a CLI tool that implements the core functionality of a version control system. It mimics Git's filesystem structure, object formats and internal protocols, making it partially Git-compatible.

The project is written in modern, object-oriented Python and has strong typing, clean class-based architecture. Only Python's build-in standard library is used.  

This project was originally inspired by the [Write Yourself A Git](https://github.com/thblt/write-yourself-a-git) guide. While it provided the foundational logic for the Git format, MiniGit is a serious structural rewrite. The codebase has been refactored to move away from procedural scripts toward a scalable OOP architecture, fixing several edge-case bugs and implementing better patterns not found in the original tutorial.
...
## Features
The CLI tool is able to understand the following commands with their arguments
| Command       | Description                                                     |
|--------------|-----------------------------------------------------------------|
| init         | Initialize an empty repository                                  |
| cat-file     | Cat the content of an object                                    |
